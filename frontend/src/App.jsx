...
// Layouts e Proteção de Rota do Admin
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* Portal do Cliente (Estrutura já estava correta) */}
        <Route path="/portal" element={<ClientProtectedRoute><ClientLayout /></ClientProtectedRoute>}>
        ...
        {/* --- ESTRUTURA CORRIGIDA DO PAINEL ADMIN --- */}
        {/* Uma rota pai que protege e aplica o layout a todas as rotas filhas */}
        <Route 
          path="/" 
          element={
            <ProtectedRoute>
        ...
        >
          {/* As rotas filhas serão renderizadas pelo <Outlet> dentro do AdminLayout */}
